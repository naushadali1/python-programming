i=1
while(i!=0):
 print ("Heres Organs name the program Inculded: \n 1.Lung \n 2.Heart \n 3.Liver \n 4.Kidney") 
 organ=input("Enter Organ Name :")
 if organ.upper()=='LUNG':
    print("Lungs diseases are:\n 1.Asthma \n 2.Pnemonia \n 3.TB \n 4. Lung Cancer\n")
    disease = input("Enter Disese name for the list of treatment: ")
 ...
 i=int(input('Enter "0" for terminate and "1" to continue : '))